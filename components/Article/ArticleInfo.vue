         ...
         <div class="article_info_wrapper__info__left">
            <div class="article_info_wrapper__info__left__block">
               <div class="article_info_wrapper__info__left__block__title">
                  <v-icon
                     size="22"
                     class="article_info_wrapper__info__left__block__title__icon"
                  >
               ...
               <span
                  class="article_info_wrapper__info__left__block__value date"
               >
            ...
            <div class="article_info_wrapper__info__left__block">
               ...
               <span
                  class="article_info_wrapper__info__left__block__value category"
               >
                  Подбор
               </span>
            </div>
            <div
               class="article_info_wrapper__info__left__block"
               v-if="article_data._all_tags.length"
            >
               <div class="article_info_wrapper__info__left__block__title">
                  <v-icon
                     size="22"
               ...
               <div class="article_info_wrapper__info__left__block__value tags">
                  ...
                  >
                     {{
                        tag.name.trim() +
                        (index === article_data._all_tags.length - 1 ? '' : ',')
                     }}
                  </a>
               </div>
            </div>
            <div class="article_info_wrapper__info__left__block">
               ...
               <span
                  class="article_info_wrapper__info__left__block__value counters"
               >
                  722 человек
               </span>
            </div>
            ...
            >
               ...
               <v-tooltip bottom>
                  <template v-slot:activator="{ on, attrs }">
                     <v-btn value="flat" v-bind="attrs" v-on="on" large>
