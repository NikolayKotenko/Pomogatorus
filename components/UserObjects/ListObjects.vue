<template>
  <v-dialog v-model="$store.state.showCabinet" max-width="800">
    <v-card>
      <v-card-title class="card_title"> Выберите объект для сохранения </v-card-title>
      ...
      <v-card-actions class="modal_footer">
        ...
        <v-btn text color="primary" @click="$store.state.showCabinet = false" large> Закрыть </v-btn>
      </v-card-actions>
    </v-card>
  </v-dialog>
</template>
