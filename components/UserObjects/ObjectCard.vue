<template>
  <div class="card_object_container__wrapper">
    ...
    <div class="card_object_container__wrapper__footer">
      <v-btn outlined color="green lighten-1" small v-if="selectedObj" min-width="150"> Выбран </v-btn>
      <v-btn color="primary" small v-else @click="setObject" min-width="150"> Выбрать </v-btn>
    </div>
