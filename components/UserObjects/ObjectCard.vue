<template>
   <div class="card_object_container__wrapper">
      <div
         class="card_object_container__wrapper__header"
      ...
      <div class="card_object_container__wrapper__info" @click="openDetailCard">
         <div class="card_object_container__wrapper__info__block">
            <span class="card_object_container__wrapper__info__block__title"
               >Площадь</span
            >
            <div
               class="card_object_container__wrapper__info__block__divider"
            ></div>
      ...
      <v-dialog max-width="800" v-model="showDetailObj">
         <ObjectDetail
            v-if="showDetailObj"
