      ...
      <template v-if="article">
        ...
        <div class="sticky_panel">
          ...
          <div class="bookmarks_and_share">
            <!--            Когда-то тут будет кнопка "Закладки" -->
...
<!--                    </VueSlickCarousel>-->
              ...
              <div class="more_articles_wrapper">
                  ...
                  <div class="title_and_tags">
                    ...
                    <div class="tags">
                      ...
                      <a
                        ...
                        :key="index"
                        class="tags_text"
                        @click="getArticlesByTag(tag.code)"
                      >
                        {{ tag.name }}
                      </a>
                    </div>
                ...
                <div v-if="filteredArticlesByTag" class="small_articles_slider">
                  <VueSlickCarousel
                    v-bind="settingsCarousel"
                  >
                    <ArticleSmallCard
