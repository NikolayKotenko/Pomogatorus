<template>
   <v-app>
      <template
         v-if="
            Object.keys($store.state.PopularSelectionsModule.popular_selections)
               .length
         "
      >
         <div class="tag-template">
            <v-textarea
               :value="
                  $store.state.PopularSelectionsModule.popular_selections.tag
                     .description
               "
               readonly
            >
         ...
         <div class="article-template list_container mt-5">
            <Article
               v-for="(article, index) in $store.state.PopularSelectionsModule
                  .popular_selections.articles"
               :key="index"
               :article="article"
            />
         </div>
         <div class="question-template mt-5">
            <Question
               v-for="(question, index) in $store.state.PopularSelectionsModule
                  .popular_selections.questions"
               :key="index"
               :props-data="question"
